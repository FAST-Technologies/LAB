...
const RegulatorWheel = (props: any) => {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <mesh name="Регулятор_напряжения" geometry={nodes.Регулятор_напряжения.geometry} material={materials['Material.011']} position={[-14.923, 18.563, 4.908]} scale={[0.608, 0.09, 0.608]} />
      </group>
    </group>
  )
}
